...
class MongooseService {
    ...
    /**
     * @description Retrieve a page of multiple documents based on the limit from the Model that matches the filters with pagination attributes
     * @param {object} [filters] Body to update the document with
     * @param page {number} the required page to be retried
     * @param {number} [limit] the number of documents per page
     * @returns {Promise} Returns the results of the pagination
     */
    paginate({page, filters = {}, limit = ACCOUNT_PAGINATION_SIZE}) {
        return this.model
